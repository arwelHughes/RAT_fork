...
alloy_isld = params(17);
au_isld = params(18);

GOLD = [Gold_Thick Gold_SLD au_isld Gold_Rough];
ALLOY_UP = [Alloy_Thick Alloy_SLD_up alloy_isld Alloy_Rough];
ALLOY_DOWN = [Alloy_Thick Alloy_SLD_down alloy_isld Alloy_Rough];
