function [output,sub_rough] = volume_thiolsam_plus_DPPC_polarised(params,bulk_in,bulk_out,contrast)
...
Cw_thick = params(13);
Bilayer_APM = params(14);
Bilayer_wph = params(15);
Bilayer_rough = params(16);
...
BILAYER = [BILHEAD ; BILTAILS ; BILTAILS ; BILHEAD];
