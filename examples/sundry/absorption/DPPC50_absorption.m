...
problem = project(name = 'DPPC_50_3pcBins', calcType = 'non polarised',...
...
problem.addBacksPar('Backs parameter 1', 5e-08, 7.88e-06, 9e-05, true);
problem.addBacksPar('Backs parameter 2', 1e-08, 5.46e-06, 9e-05, true);
problem.addBacksPar('Backs parameter 3', 1e-06, 9.01e-06, 9e-05, true);
problem.addBacksPar('Backs parameter 4', 1e-06, 5.61e-06, 9e-05, true);
